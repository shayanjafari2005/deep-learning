...
class RestaurantScoreAnalyzer:
    def __init__(self, csv_file_path):
        ...
        self.tokened_list = self.word_tokenizer(3)
    ...
    def analyze_scores(self):
        ...
        people_rate = self.people_rate_sum(2)
...
if __name__ == "__main__":
    ...
    analyzer = RestaurantScoreAnalyzer("snappfood_2.csv")
    analyzer.analyze_scores()
    end_time = time.time()
    print("مدت زمان اجرا:", round(end_time - start_time, 2), "ثانیه")


# our score to your restaurant is  7.99  from 10
# مدت زمان اجرا: 0.36 ثانیه
